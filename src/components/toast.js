	...
	render: function() {
		var leftToast = (
			<g onClick={this.handleClick} id="ToastLeft" className="toast">
				...
				<path fill="#EFEDD8" d="M496.902,295.573c0,0,0.751-102.024-10.045-101.681c11.357-6.922,12.564-36.246-1.426-49.189
		...
		var rightToast = (
			...
			<path fill="#EFEDD8" d="M618.036,324.126c0,0,8.098-101.705-2.695-102.14c11.827-6.086,15.142-35.247,2.121-49.164
