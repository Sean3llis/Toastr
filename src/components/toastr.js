			...
			<div className="row">
				<div className="col-sm-9" style={{textAlign: 'right'}}>
					<svg width={this.props.width + 'px'} height={this.props.height + 'px'} viewBox={this.props.viewBox} >
						...
						<g id="toast-outlines">
							<path className="toast-outline" id="outline-right" fill="none" stroke="#333333" strokeWidth="4"  d="M427.512,161.306
							...
							<path className="toast-outline" id="outline-left" fill="none" stroke="#333333" strokeWidth="4"  d="M412,316.599
				...
				<div className="col-sm-3 stat-column">
