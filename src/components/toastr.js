		...
		return (
			<div>
				<svg width={this.props.width + 'px'} height={this.props.height + 'px'} viewBox={this.props.viewBox} >
					...
					<g id="toast-outlines">
						<path strokeDasharray="10" className="toast-outline" id="outline-right" fill="none" stroke="#F2F2F2" strokeLinecap="round" strokeWidth="4"  d="M427.512,161.306
							...
							c0.323,0,0.567,0.033,0.892,0.023c3.962,1.477,14.348,3.589,44.558,6.391c28.786,2.669,58.575,4.352,81.73,4.352
							c0.005,0,0.007,0,0.012,0c42.501,0,60.179-4.551,60.961-15.333c0.103-1.188,2.054-23.956,2.989-47.412
							c1.486-37.29-0.581-49.704-2.622-54.622c3.666-3.949,6.326-9.831,7.56-16.946c2.37-13.668-0.78-28.28-8.991-36.281
							c-24.554-23.928-79.446-17.072-96.751-8.502C505.334,151.333,451.691,140.945,427.512,161.306z"/>
						<path strokeDasharray="10" className="toast-outline" id="outline-left" fill="none" stroke="#F2F2F2" strokeLinecap="round" strokeWidth="4"  d="M412,316.599
							c-10.69,0.307-20.728,0.401-29.063,0.401c-0.006,0-0.011,0-0.016,0c-16.471,0-32.631-0.372-45.504-1.052
							c-13.329-0.703-18.762-1.456-21.309-2.247c-0.991,0.094-1.995,0.142-3.002,0.142c-9.689,0-20.97-4.703-21.566-10.998l-0.01-0.117
