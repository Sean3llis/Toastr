		...
		return (
			<div id="toastr-wrapper">
					<svg width={this.props.width + 'px'} height={this.props.height + 'px'} viewBox={this.props.viewBox} >
						...
						<g id="toast-outlines">
							<path className="toast-outline" strokeDasharray="5px" id="outline-right" fill="none" stroke="#F2F2F2" strokeWidth="5"  d="M427.512,161.306
							...
							<path className="toast-outline" strokeDasharray="5px" id="outline-left" fill="none" stroke="#F2F2F2" strokeWidth="5"  d="M412,316.599
