	...
	render: function() {
      ...
      <div id="react-logo">
        <svg version="1.1" id="Layer_2" x="0px" y="0px"
          ...
          <circle className="bg-fill" cx="299.529" cy="299.628" r="50.167"/>
          <path className="bg-stroke" fill="none" stroke="#F2F2F2" strokeWidth="24" d="M299.529,197.628
          ...
          <path className="bg-stroke" fill="none" stroke="#F2F2F2" strokeWidth="24" d="M210.736,248.922
          ...
          <path className="bg-stroke" fill="none" stroke="#F2F2F2" strokeWidth="24" d="M210.821,351.482
