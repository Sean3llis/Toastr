	...
	var toastr = React.createClass({
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'col-sm-9', style: { textAlign: 'right' } },
					React.createElement(
						'svg',
				...
				React.createElement(
					'div',
					{ className: 'col-sm-3 stat-column' },
