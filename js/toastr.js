		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(Smoke, { status: this.state.toastRight }),
	...
	var smoke = React.createClass({
	  ...
	  componentWillMount: function () {
	    Velocity.RegisterEffect('smoke:float', {
	      ...
	      calls: [[{ strokeDashoffset: "-=200.5", opacity: 1 }, 1, { stagger: 200, easing: 'swing' }], [{ opacity: 0 }, 0.2, { stagger: 200, easing: 'swing' }]]
	    });
	  },
